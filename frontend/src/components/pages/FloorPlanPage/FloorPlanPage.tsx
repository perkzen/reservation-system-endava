    ...
    <>
      ...
      <map name="image-map" className={classes.Map}>
        <area
          ...
          shape="rect"
          onClick={() =>
            navigate('/Maribor/628b83b9eec9c04913d34836', { state: 'Office 1' })
          }
        />
        <area
          target=""
          ...
          shape="rect"
          onClick={() =>
            navigate('/Maribor/628b837feec9c04913d3482b', { state: 'Office 2' })
          }
        />
        <area
          target=""
          ...
          shape="rect"
          onClick={() =>
            navigate('/Maribor/628bd89b1fcf64e4dadfa95d', { state: 'Office 3' })
          }
        />
        <area
          target=""
          ...
          shape="rect"
          onClick={() =>
            navigate('/Maribor/628bea931a656573ac780e08', { state: 'Office 4' })
          }
        />
      </map>
    </>
